...
if __name__ == "__main__":
    for dataset in ['total_stop']:
        ...
        t1 = MyThread(model_run, args=(dataset, 'HCOATT_CTW', 3, 3, 'fm'))
        t2 = MyThread(model_run, args=(dataset, 'HCOATT_CWT', 4, 3, 'fm'))
        t3 = MyThread(model_run, args=(dataset, 'HCOATT_TWC', 5, 3, 'fm'))
