...
class PredictionLayer(nn.Module):
    ...
    def forward(self, feature, uid, iid,travel_type,travel_month):
        if self.output == "lfm" or "fm" or "nfm":
            return self.model(feature, uid, iid,travel_type,travel_month)
        else:
...
class LFM(nn.Module):
    ...
    def forward(self, feature, user_id, item_id,travel_type,travel_month):
...
class FM(nn.Module):
    ...
    def forward(self, feature, uids, iids,travel_type,travel_month):
